...
Put a new thing inside this root node by calling <code>.add_child</code>:

  parent = Tag.create!(:name => 'Parent')
  grandparent.add_child parent

Put another thing inside the "parent" node. This time we'll appending to the <code>children</code> collection (which is equivalent to <code>.add_child</code>).
...
Now you should have something that resembles this:
  ...
  grandparent.self_and_descendants
